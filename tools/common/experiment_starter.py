...
import pandas as pd
import os
from tools.common.utils import load_demographic_data, add_demographic_information
...
def experiment_starter(capacities_file, subjects_file, baseline_unedited, baseline_empty, baseline_unique):
    ...
    assert not (baseline_unedited and baseline_unique)
    assert not (baseline_unique and baseline_empty)
