...
from tools.common.utils import load_data, add_command, get_chromosome_path, load_data_multichromosome
import os
import pandas as pd
import gzip
...
def convert_2_vcf(experiment_number):
    ...
    return launch_job_multichromosome("convert_2_vcf", args, memory="16g", cpus="1", num_tasks=str(num_tasks))
