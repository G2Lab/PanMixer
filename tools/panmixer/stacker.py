import numpy as np
from tools.common.utils import load_data, load_data_multichromosome
...
def stacker(strategy, experiment_number):
    ...
    return launch_job_multichromosome("stacker", args, memory="32g", cpus="1", num_tasks=str(num_tasks))
