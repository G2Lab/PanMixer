...
mkdir -p $data_prefix/all/$ROW_ID
...
def combine_vcfs(experiment_number):
    ...
    return launch_job_with_custom_command_by_rowid("combine_vcfs", id_counter, command, memory="32g", cpus="1", num_tasks=str(num_tasks))
