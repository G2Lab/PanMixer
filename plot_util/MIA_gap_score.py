...
def plot_combo_privacy_utility():
    ...
    conditions = {
        "PanMixer": {
            "link_column": "reverse_genotypes_score",
    ...
    plt.tight_layout()
    plt.savefig(f"{PLOT_OUT_PATH}/RECOMB_Supplementary_MIA_Gap_Score.png")
    plt.savefig(f"{PLOT_OUT_PATH}/RECOMB_Supplementary_MIA_Gap_Score.pdf")
    plt.close()
