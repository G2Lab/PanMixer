...
DEFAULT_FONT = "DejaVu Sans"  # Change to preferred font
...
def apply_style():
    params = {
        ...
        'text.usetex': False,  # Use matplotlib's built-in mathtext
        'font.family': 'sans-serif',  # Ensures sans-serif is used
        'font.sans-serif': ['DejaVu Sans'],  # Correct place for Helvetica
        'savefig.bbox': 'tight',
        'savefig.format': 'pdf',
        'savefig.dpi': 300,
    }
...
FONT = font_manager.FontProperties(family='DejaVu Sans', size=LABEL_SIZE)