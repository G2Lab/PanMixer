...
MAIN_EXPERIMENT = 27   # experiment with Beagle imputation accuracy results
CHROMOSOME      = 21   # chromosome for which accuracy_results.json was computed
...
def plot_beagle_vs_major_allele(experiment):
    data_df = read_data()
...
if __name__ == "__main__":
    apply_style()
    plot_beagle_vs_major_allele(MAIN_EXPERIMENT)
